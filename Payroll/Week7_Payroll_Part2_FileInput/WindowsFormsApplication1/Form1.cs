...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void btnAddPayCheck_Click(object sender, EventArgs e)
        {
            ...
            lblFeedback.Text = FileIO.writeFile(@"c:\Test\Payroll.csv", myPayRollRecord);
        }

        private void txtReadWholeFile_Click(object sender, EventArgs e)
        {
            //Creating a string for holding data/feedback
            string strData = "";
            //Get the data from the file
            strData = FileIO.readFile(@"c:\Test\Payroll.csv");
