<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EBookSearch.aspx.cs" Inherits="SE256_Activity_MattG.EBookSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DataGrid ID="dgResults" runat="server" AutoGenerateColumns="false" >
        <Columns>
            ...
            <asp:HyperLinkColumn Text="Edit" DataNavigateUrlFormatString="~/Backend/EBookMgr.aspx?EBook_ID={0}"
                DataNavigateUrlField="eBook_ID"/>
        </Columns>
    </asp:DataGrid>

    <br /><br />
    <br /><br />
    <h1>Another output option: Creating our own output while looping thru records using a repeater and ItemTemplate</h1>
